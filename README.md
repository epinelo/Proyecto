...
## Revisión Final
Para el cierre de este proyecto, realicé las últimas y pequeñas modificaciones al código. Corregí todos los comentarios del código en base a las normas de los comentarios que vimos en clase. Agregue paréntesis a todos los condicionales if que hay en el código para la facilidad de su lectura y finalmente desheché los argumentos de algunas funciones porque las variables que había en esas funciones son globales, por lo que no era necesario pasarlas como argumentos.
